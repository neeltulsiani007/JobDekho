...
function Recruiterformmultistep2(){
  ...
  useEffect(() => {
    ...
    if(gobacktoform)
    {
      return <Navigate to="/recruitmentformmultistep3" />
    }
  ...
  const insertrecruiter = async()=>{
    ...
    const res = await axios.post(`${baseUrl}/insertrecruiter`,{
     name:user.name,
     number:user.number,
     email:user.email,
  ...
  <ToastContainer
      ...
      theme="colored"
      />
   <div class="bg-white lg:h-[486px]  lg:flex  rounded-2xl  shadow-sm shadow-gray-400 lg:w-screen  max-w-5xl">
      <div
...
<div className="  w-full px-[10%] pt-28 items-center justify-center">
      ...
      <div class="lg:w-[78%] px-5 h-full lg:pt-10 pt-10 lg:pb-0 pb-5 items-center justify-center ">
        {/* <div class>hello</div> */}
      ...
      <div
      class = "text-black text-xl pt-10 lg:pt-8 font-semibold"
      >Enter OTP</div>
      <div class="box-content p-5 w-auto h-auto  ">
         <div class="flex-col md:space-x-7 space-x-2 lg:space-y-2 space-y-4">       
          <input
            name="otp1"
            type="text"
            id="otp1"
      ...
      <div class="flex items-center justify-center text-lg font-semibold lg:pt-5 pt-10  ">
            Didn't receive OTP ? , click below to resend OTP (enabled after 30 seconds)
          </div>
          <div class="flex items-center justify-center lg:mb-0 mb-8  pt-8 ">
         {!loadingresend?
        <button id = "subbutton"
...
export default Recruiterformmultistep2
