...
<div class="heading text-center font-bold text-3xl m-5 text-gray-800 font-sans">New Post</div>
  ...
  <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
   ...
   <div class="buttons flex -mb-4">
      ...
      <button
      type='submit'
      class="btn border flex border-blue-500 p-1 px-4   text-center text-xl my-3 h-10  font-semibold cursor-pointer text-white hover:bg-blue-700 ml-2 bg-blue-500" 
