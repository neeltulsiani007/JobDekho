...
function Loginpage(){
  ...
  return (
      <div class=" bg-zinc-200 font-sans">
       <div  
        class="text-zinc-200 bg-zinc-200 h-auto w-12 mx-12 py-2 focus:ring-2 focus:ring-inset focus:ring-white"
        >sr
        </div> 
        <div id = "loginpage1" class="min-h-screen  w-screen items-center justify-center flex bg-zinc-200">
        <div class="md:py-20 py-16 flex max-w-4xl md:p-8 p-3 mb-32  items-center bg-white shadow-lg shadow-slate-900">
      ...
      />
        ...
        class="p-2 mt-8 rounded-xl  text-xl w-72 h-12 border-[1.5px] border-black"
        name='number'
        value={number}
        ...
        <Form.Field>
            ...
            placeholder ="Password"
              class="p-2 mt-8 border-[1.5px] border-black rounded-xl  text-xl w-72 h-12"
              name='password'
              value={password}
        ...
        <div class="mt-5 text-lg   text-[#002D74]">
      ...
      <div class="mt-5 text-sm  py-2 text-[#002D74]">
       ...
       <div className='space-x-10 md:pl-14 w-full md:block hidden '>
        <img src = {require('./login2.png')} alt='not loading'
        class="h-full w-96 "></img>
       </div>
       </div>
    </div>
    </div> 
