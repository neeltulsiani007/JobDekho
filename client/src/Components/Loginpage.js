...
function Loginpage(){
  ...
  <section class="border-red-500 bg-zinc-200 min-h-screen pt-12 flex items-center justify-center">
    <div class="bg-zinc-100 p-5 flex  rounded-2xl  shadow-md shadow-black max-w-4xl">
      <div class="lg:w-1/2 px-5 h-full lg:pt-7 pt-4 ">
        ...
        <form class="mt-9" action="#" method="POST">
          ...
          <div class="mt-6">
            ...
            fill="gray"
             class="bi bi-eye absolute cursor-pointer w-6 h-6  ml-[252px]   lg:ml-[350px] -mt-[35px]"
             viewBox="0 0 16 16">
            ...
            onClick={handlepassword} fill="currentColor" class="bi bi-eye-slash absolute cursor-pointer -mt-[35px] w-6 h-6 ml-[252px]    lg:ml-[350px]" viewBox="0 0 16 16">
...
{/* 
        ...
        <div class="lg:text-base text-sm flex  items-center mt-4">
