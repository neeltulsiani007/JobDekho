      ...
      <div class="lg:w-1/2 w-full px-5 h-full lg:pt-7 pt-4 ">
        ...
        <form class="mt-9"  method="POST">
          ...
          <div class="mt-6">
            ...
            fill="gray"
             class="bi bi-eye absolute cursor-pointer w-6 h-6  ml-[252px] md:block hidden  lg:ml-[350px] -mt-[35px]"
             viewBox="0 0 16 16">
            ...
            onClick={handlepassword} fill="currentColor" class="bi bi-eye-slash absolute hidden md:block cursor-pointer -mt-[35px] w-6 h-6 ml-[252px]    lg:ml-[350px]" viewBox="0 0 16 16">
